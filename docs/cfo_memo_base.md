# Clay-Style AI SaaS — CFO Model Snapshot (base)

**Period:** 2026-01 → 2028-12 (monthly)

## Executive summary
- Ending customers: **1,289**
- Ending MRR: **$698,356** (Ending ARR: **$8,380,268**)
- Total revenue (period): **$13,348,946**
- Gross margin (avg): **77.1%**
- Revenue mix (avg): Seats **92.6%** | Credits **7.4%**
...
- Blended NRR (monthly avg): **96.01%** | Blended GRR (monthly avg): **84.14%**
- Seats/customer: **4.00** @ **$99/seat/mo**
- Credits/customer/mo: **2,500** @ **$12.00 per 1k**

## Latest-month drivers (MRR bridge)
- Starting existing MRR: **$680,682**
- Churned MRR (lost): **-$154,193**
- Expansion MRR (gained): **+$149,145**
- New MRR from new customers: **+$22,722**
- Ending MRR: **$698,356**

## Notes
- This is a simplified, CFO-ready planning model intended for fast scenario iteration.
- Outputs include QA checks, chart pack, and a repeatable publish pipeline.
